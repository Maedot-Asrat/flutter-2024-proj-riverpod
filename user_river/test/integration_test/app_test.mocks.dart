...
// in zemnanit/test/integration_test/app_test.dart.
...
class MockAuthService extends _i1.Mock implements _i8.AuthService {
  ...
  @override
  _i4.Future<void> fetchAppointments() => (super.noSuchMethod(
        Invocation.method(
          #fetchAppointments,
          [],
        ),
  ...
  @override
  _i4.Future<void> fetchSalons() => (super.noSuchMethod(
        Invocation.method(
          #fetchSalons,
          [],
        ),
  ...
  @override
  _i4.Future<void> editAppointment(
    String? id,
    String? hairstyle,
    String? date,
    String? time,
